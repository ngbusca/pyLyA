...
def var_lss(data):
    ...
    for i in range(nlss):
        ...
        mig = iminuit.Minuit(chi2,forced_parameters=("eta","vlss"),eta=1.,vlss=0.1,error_eta=0.05,error_vlss=0.05,errordef=1.,print_level=0,limit_eta=(0.5,1.5),limit_vlss=(0.01,0.3))
        mig.migrad()
